// Görseller.
//
// Fotoğraflar şu an hâlâ Wix'in görsel sunucusunda (static.wixstatic.com) duruyor.
// Wix aboneliği sonlandırılmadan önce dosyalar indirilip `static/gorseller/`
// içine konmalı ve her kaydın `local` alanı doldurulmalıdır — `imgUrl()`
// otomatik olarak yerel dosyayı tercih eder, tek satır bile değiştirmeye gerek kalmaz.
